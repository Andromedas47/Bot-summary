...
function NavSection({
  ...
  return (
    <div>
      <p className="px-3 mb-1.5 text-[0.625rem] font-semibold uppercase tracking-widest text-slate-500">
        {title}
      </p>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm transition-all duration-150 ${
                isActive
                  ? "bg-[#06C755] text-white font-semibold shadow-sm"
  ...
  return (
    <aside className="flex h-full w-64 flex-col border-r border-slate-800 bg-slate-900">
      ...
      <div className="flex h-14 items-center gap-3 px-4 border-b border-slate-800">
        <div className="flex size-7 shrink-0 items-center justify-center rounded-lg bg-[#06C755] shadow-sm">
        ...
        <div className="min-w-0">
          <span className="block text-[0.8125rem] font-semibold text-white leading-tight">LINE Dashboard</span>
          <span className="block text-[0.625rem] text-slate-500 leading-tight">Bot Summary</span>
        </div>
      </div>
      ...
      <div className="px-4 py-3 border-t border-slate-800">
        <p className="text-[0.625rem] text-slate-600 text-center tracking-wide">
          v0.1.0
        </p>
      </div>
    </aside>
