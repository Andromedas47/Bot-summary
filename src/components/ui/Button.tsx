...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "bg-[#06C755] text-white shadow-sm hover:bg-[#05b34d] focus-visible:ring-[#06C755]",
  secondary:
...
const sizeClasses: Record<ButtonSize, string> = {
  sm: "h-8 min-h-11 sm:min-h-0 px-3 text-xs",
  md: "h-9 min-h-11 sm:min-h-0 px-4 text-sm",
