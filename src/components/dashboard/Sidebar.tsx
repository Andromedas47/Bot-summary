  ...
  return (
    <aside className="flex h-full w-64 flex-col bg-slate-900">
      ...
      <div className="flex h-16 items-center gap-3 px-6 border-b border-slate-800">
        <div className="flex size-8 items-center justify-center rounded-lg bg-[#06C755]">
        ...
        <span className="text-sm font-semibold text-white">LINE Dashboard</span>
      </div>
      ...
      <div className="p-4 border-t border-slate-800">
        <p className="text-xs text-slate-500 text-center">bot-summary v0.1.0</p>
      </div>
    </aside>
  );
}
